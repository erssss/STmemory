...
from stmem.storage.config.pgvector import PGVectorConfig
from stmem.storage.config.sqlite import SQLiteConfig, SQLiteGraphConfig
...
class VectorStoreFactory:
    ...
    def create(cls, provider_name, config):
        ...
        Args:
            provider_name (str): The provider name (e.g., 'pgvector', 'sqlite')
...
class GraphStoreFactory:
    ...
    def create(cls, provider_name, config):
        ...
        Args:
            provider_name (str): The provider name (e.g., 'sqlite')
            config: Configuration object or dict. If dict, will convert to provider config
