...
class UserMemory:
    ...
    def __init__(
        ...
        db_path = getattr(vector_store, "db_path", None) or getattr(
            vector_store, "database_path", None
        )
        profile_store_config = {
            "table_name": "user_profiles",
            "database_path": db_path or "./data/stmem_user_profiles.db",
        }
    ...
    def get(
        ...
        """
        return self.memory.get(memory_id, user_id)
    ...
    def update(
        ...
        """
        return self.memory.update(memory_id, content, user_id, metadata=metadata)
    ...
    def delete_all(
        ...
        Returns:
            True if deleted successfully, False otherwise
        """
        result = self.memory.delete_all(user_id, run_id)
    ...
    def get_all(
        ...
        """
        return self.memory.get_all(user_id, run_id, limit, offset, filters)
