...
class QwenRerankConfig(BaseRerankConfig):
    ...
    _provider_name = "qwen"
    _class_path = "stmem.integrations.rerank.qwen.QwenRerank"
...
class JinaRerankConfig(BaseRerankConfig):
    ...
    _provider_name = "jina"
    _class_path = "stmem.integrations.rerank.jina.JinaRerank"
...
class ZaiRerankConfig(BaseRerankConfig):
    ...
    _provider_name = "zai"
    _class_path = "stmem.integrations.rerank.zai.ZaiRerank"
...
class GenericRerankConfig(BaseRerankConfig):
    ...
    _class_path = "stmem.integrations.rerank.generic.GenericRerank"
