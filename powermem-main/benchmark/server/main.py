...
class BenchmarkSettings(BaseSettings):
    ...
    def set_defaults(self) -> "BenchmarkSettings":
        ...
        if self.llm_provider != "ollama" and not str(self.llm_api_key or "").strip():
            raise ValueError("llm_api_key is required unless llm_provider=ollama")

        if self.embedding_provider != "ollama" and not str(self.embedding_api_key or "").strip():
            raise ValueError("embedding_api_key is required unless embedding_provider=ollama")
